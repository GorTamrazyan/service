...
export default function AdminOrdersPage() {
    ...
    return (
        <div className="p-6 space-y-6">
            {/* Header */}
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-[var(--color-text)] mb-2">Order Management</h1>
                <p className="text-[var(--color-gray-600)]">Manage and track all customer orders</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="bg-[var(--color-card-bg)] rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <p className="text-sm font-medium text-[var(--color-gray-600)]">Total Orders</p>
                ...
                <div className="bg-[var(--color-card-bg)] rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <p className="text-sm font-medium text-[var(--color-gray-600)]">Pending</p>
                ...
                <div className="bg-[var(--color-card-bg)] rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <p className="text-sm font-medium text-[var(--color-gray-600)]">Delivered</p>
                            <p className="text-2xl font-bold text-[var(--color-text)]">{stats.delivered}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-[var(--color-card-bg)] rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <p className="text-sm font-medium text-[var(--color-gray-600)]">Revenue</p>
                            <p className="text-2xl font-bold text-[var(--color-text)]">${stats.revenue.toFixed(2)}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-[var(--color-card-bg)] rounded-lg shadow overflow-hidden">
                <div className="px-6 py-4 border-b border-[var(--color-border)]">
                    <h3 className="text-lg font-medium text-[var(--color-text)]">All Orders</h3>
                </div>
                ...
                {orders.length === 0 ? (
                    <div className="p-16 text-center">
                        ...
                        <p className="text-[var(--color-gray-500)]">Orders will appear here once customers place them.</p>
                    </div>
                ) : (
                    <div className="overflow-x-auto">
                        <table className="min-w-full divide-y divide-[var(--color-border)]">
                            ...
                            <tbody className="bg-[var(--color-card-bg)] divide-y divide-[var(--color-border)]">
                                {orders.map((order) => (
                                    <tr key={order.id} className="hover:bg-[var(--color-gray-50)]">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-[var(--color-text)]">
                                            <div>
                                                ...
                                                <div className="text-[var(--color-gray-500)]">{order.customerInfo.email}</div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-[var(--color-text)]">
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-[var(--color-gray-50)] rounded-lg p-4">
                                    <h3 className="font-semibold text-[var(--color-text)] mb-3">Customer Information</h3>
                                ...
                                {/* Order Items */}
                                <div>
                                    <h3 className="font-semibold text-[var(--color-text)] mb-3">Order Items</h3>
                                    <div className="space-y-2">
                                        {selectedOrder.products.map((product, index) => (
                                            <div key={index} className="flex justify-between items-center bg-[var(--color-gray-50)] rounded p-3">
                                                <div>
                                                    <span className="font-medium">{product.name}</span>
                                                    <span className="text-[var(--color-gray-500)] ml-2">× {product.quantity}</span>
                                                </div>
                                ...
                                {/* Order Info */}
                                <div className="bg-[var(--color-gray-50)] rounded-lg p-4">
                                    <h3 className="font-semibold text-[var(--color-text)] mb-3">Order Information</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                        <div>
