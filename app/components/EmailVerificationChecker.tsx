...
import { checkEmailVerification, resendVerificationEmail } from '../lib/firebase/auth-utils';
...
export default function EmailVerificationChecker({ user, onVerified }: EmailVerificationCheckerProps) {
            ...
            <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
                <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500 mt-4">
                        Не получили письмо? Проверьте папку "Спам" или нажмите кнопку выше.
                    </p>
                </div>
            </div>
        </div>
